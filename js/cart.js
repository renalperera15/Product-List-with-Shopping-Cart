...
function displayCart() {
    ...
    const cartHeading = document.getElementById("cart-heading"); // Make sure your <h2> has id="cart-heading"
    cartDiv.innerHTML = "";
    ...
    if (cart.length === 0) {
        ...
        cartHeading.innerText = "Your Cart (0 items)";
        return;
    }
    ...
    // Update total and heading
    document.getElementById("total").innerText = total.toFixed(2);
    cartHeading.innerText = `Your Cart (${totalItems} item${totalItems !== 1 ? "s" : ""})`;
}
